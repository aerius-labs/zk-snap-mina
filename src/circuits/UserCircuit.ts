  ...
  methods: {
    generateProof: {
      ...
      method(
        ...
        Provable.log('msg in circuit: ', message);
        Provable.log('r in circuit', r_encryption);
        Provable.log('Encrypted Vote: ', encryptedVote);
        Provable.log('Input Encrypted Vote: ', userState.encrypted_vote);
